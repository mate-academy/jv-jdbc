...
import mate.jdbc.exception.DbConnectionException;
import mate.jdbc.exception.DriverLoadingException;
import mate.jdbc.exception.PropertyFileReadingException;
...
public class ConnectionUtil {
    ...
    static {
        try {
            ...
            logger.info("Driver for MySQL DB loaded successfully");
