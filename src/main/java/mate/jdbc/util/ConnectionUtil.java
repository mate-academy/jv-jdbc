...
public class ConnectionUtil {
    private static final String CANT_LOAD_JDBC_DRIVER_MESSAGE = "Can't load JDBC driver to MySQL";
    private static final String CANT_CREATE_CONNECTION_MESSAGE = "Can't creat connection to DB";
    private static final String USER = "user";
    private static final String PASSWORD = "password";
    private static final String USER_VALUE = "root";
    private static final String PASSWORD_VALUE = "1234567890";
    private static final String JDBC_CONNECTION_INFO = "jdbc:mysql://localhost:3306/manufacturer_db";
