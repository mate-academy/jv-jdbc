...
public class ManufacturerDaoImpl implements ManufacturerDao {
    ...
    public Manufacturer create(Manufacturer manufacturer) {
        ...
        try (Connection connection = ConnectionUtil.getConnection();
             PreparedStatement createManufacturerStatement =
                     connection.prepareStatement(insertFormatRequest, PreparedStatement.RETURN_GENERATED_KEYS)) {
            ...
            throw new DataProcessingException("Cannot insert manufacturer to DB. Manufacturer: " + manufacturer, e);
        }
        return manufacturer;
    }
    ...
    public Optional<Manufacturer> get(Long id) {
        String getManufacturerByIdRequest = "SELECT * FROM manufacturers WHERE id = ? AND is_deleted = false;";
        try (Connection connection = ConnectionUtil.getConnection();
            ...
            throw new DataProcessingException("Cannot get manufacturer by id from DB. Params: id:" + id, e);
        }
    }
    ...
    public Manufacturer update(Manufacturer manufacturer) {
        ...
        try (Connection connection = ConnectionUtil.getConnection();
            ...
            throw new DataProcessingException("Cannot update manufacturer in DB. Manufacturer: " + manufacturer, e);
        }
    }
    ...
    public boolean delete(Long id) {
        ...
        try (Connection connection = ConnectionUtil.getConnection();
            ...
            throw new DataProcessingException("Cannot delete manufacturer from DB. Params: id: " + id, e);
        }
    }
