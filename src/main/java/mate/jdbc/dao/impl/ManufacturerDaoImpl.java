...
public class ManufacturerDaoImpl implements ManufacturerDao {
    ...
    public Optional<Manufacturer> get(Long id) {
        String selectByIdRequest = "SELECT * FROM manufacturers WHERE id = ? AND is_deleted = 'false';";
        try (Connection connection = ConnectionUtil.getConnection();
             PreparedStatement getSelectedManufacturer = connection.prepareStatement(selectByIdRequest)) {
    ...
    public List<Manufacturer> getAll() {
        ...
        try (Connection connection = ConnectionUtil.getConnection();
             PreparedStatement getAllManufacturers = connection.prepareStatement(selectAllRequest)) {
    ...
    public boolean delete(Long id) {
        String deleteRequest = "UPDATE manufacturers SET is_deleted = 'true' WHERE id =? AND is_deleted = 'false';";
        try (Connection connection = ConnectionUtil.getConnection();
