...
public class ManufecturersDaoImpl implements ManufecturersDao {
    ...
    public Manufacturer get(Long id) {
        ...
        try (Connection connection = ConnectionUtil.getConnection();
             PreparedStatement getManufacturerStatement = connection.prepareStatement(getManufacturerQuerry);) {
    ...
    public boolean update(Long id, Manufacturer manufacturer){
        String deleteManufacturerRequest = "UPDATE manufacturers SET name = ?, country = ?, is_deleted = false WHERE id = ?";
        try (Connection connection = ConnectionUtil.getConnection();
             PreparedStatement updateManufacturerStatement = connection.prepareStatement(deleteManufacturerRequest, PreparedStatement.RETURN_GENERATED_KEYS);){
    ...
    public boolean delete(Long id){
        ...
        try (Connection connection = ConnectionUtil.getConnection();
            PreparedStatement deleteManufacturerStatement = connection.prepareStatement(deleteManufacturerRequest, PreparedStatement.RETURN_GENERATED_KEYS);){
